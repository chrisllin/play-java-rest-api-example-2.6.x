...
public class IntegrationTest extends WithApplication {
    ...
    public void testList() {
        ...
        repository.create(new PostData("title", "body", "author"));
    ...
    //unit test to make sure author get displayed
    @Test
    public void testAuthorPostsList() {
        PostRepository repository = app.injector().instanceOf(PostRepository.class);
        repository.create(new PostData("title", "body", "author"));

        Http.RequestBuilder request = new Http.RequestBuilder()
                .method(GET)
                .uri("/v1/posts/author/author");
    ...
    public void testTimeoutOnUpdate() {
        ...
        JsonNode json = Json.toJson(new PostResource("1", "http://localhost:9000/v1/posts/1", "some title", "somebody", "some Author"));
